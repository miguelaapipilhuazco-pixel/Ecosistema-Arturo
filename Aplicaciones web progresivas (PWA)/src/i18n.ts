...
const resources = {
  ...
  es: {
    translation: {
      ...
      "Sincronizando con Cloud": "Sincronizando con la nube",
      ...
      "Captura": "Captura",
      "Ajustes de Runtime": "Ajustes de entorno de ejecución",
      ...
      "Vincular Identity": "Vincular identidad",
      "Universal Compatibility Engine": "Motor de compatibilidad universal",
      "RUNTIME": "ENTORNO",
